    ...
    const blogs = [
        {
            ...
            imgSrc: "src\\assets\\blogs\\blog1.png"
        },
        {
            date:"05.03.2021",
            ...
            imgSrc: "src\\assets\\blogs\\blog2.png"
        },
        {
            date:"05.03.2021",
            ...
            imgSrc: "src\\assets\\blogs\\blog3.png"
        },
  ...
  return (
    <div className=' px-32 flex flex-col gap-8 w-full mt-12 text-[#414141] pb-12'>
        <div className=' w-full flex flex-row justify-between'>
            ...
            <a href="#" className=' flex flex-row gap-4 mr-4 justify-end items-center hover:text-[#70C05B] transition-all delay-75 duration-300 w-full'>Все статьи<FaChevronRight size={14}/></a>
            </div>
