...
function Footer() {
  return (
<div className='bg-[#F9F4E2] w-full py-6  h-28 px-32' style={{backgroundImage:"url(src/assets/bg.png)"}}>
        <div className='grid grid-cols-12 w-full'>
            <div className='col-span-8 flex flex-row items-center justify-between'>
                <img src='src\assets\logoFooter.svg' alt='logo-end'/>
            ...
            <div className='col-span-4 flex flex-row justify-end gap-8 items-center'>
                <div className='flex flex-row justify-center items-center gap-4'>
                    <a href="">
                    <img src='src\assets\instagram.svg' className=' hover:scale-105 transition delay-75 duration-150'/>
                    </a>
                    <a href="">
                    <img src='src\assets\facebook.svg' className=' hover:scale-105 transition delay-75 duration-150'/>
                    </a>
                    <a href="">
                    <img src='src\assets\vk.svg' className=' hover:scale-105 transition delay-75 duration-150'/>
                    </a>
                    <a href="">
                    <img src='src\assets\odn.svg' className=' hover:scale-105 transition delay-75 duration-150'/>
                    </a>
