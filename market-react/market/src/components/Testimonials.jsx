    ...
    <div className=' flex flex-col gap-6 items-start text-[#414141] w-full'>
        ...
        <div className=' grid grid-cols-9 gap-6 w-full'>
           ...
           <div className=' col-span-5 flex flex-col gap-6'>
            <CommentaryCard username={`Али`} rate={4} date={`20.03.2001`} comments={`Какой то длинный текст`}/>
            <CommentaryCard username={`Али`} rate={5} date={`20.03.2001`} comments={`Какой то длинный текст`}/>
            <CommentaryCard username={`Али`} rate={1} date={`20.03.2001`} comments={`Какой то длинный текст`}/>
            <CommentaryForm/>
